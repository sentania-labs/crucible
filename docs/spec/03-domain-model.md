...
| **WorkerImage** | A built worker image: the harnesses it carries and the installed version of each, digest, build inputs. Each harness has its own default image and the previous one a rollback returns to (ADR 0016). | Crucible |
