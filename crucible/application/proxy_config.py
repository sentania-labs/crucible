...
def worker_proxy_config(subnet: str, hosts: list[str], local_endpoints: list[str]) -> str:
    lines = [
...
def main() -> None:
    ...
    parser.add_argument("--local-endpoint", action="append", default=[])
    args = parser.parse_args()
    args.output.write_text(
        worker_proxy_config(args.subnet, args.host, args.local_endpoint), encoding="utf-8"
    )
