...
Revision ID: 0022_first_run_setup
Revises: 0021_command_timeout
"""
...
from crucible.adapters.persistence.migrations.versions._0021_command_timeout import (
    _event_kinds as _previous_event_kinds,
)

revision = "0022_first_run_setup"
down_revision = "0021_command_timeout"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    # The audit trail outlives a rollback, as in 0017, 0020 and 0021: the events move to an
